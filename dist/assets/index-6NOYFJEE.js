...
`)+`
`+_);const U=D+S+f,P=D+_+h,F=hv(l,l.VERTEX_SHADER,U),I=hv(l,l.FRAGMENT_SHADER,P);l.attachShader(T,F),l.attachShader(T,I),i.index0AttributeName!==void 0?l.bindAttribLocation(T,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(T,0,"position"),l.linkProgram(T);function z(k){if(r.debug.checkShaderErrors){const se=l.getProgramInfoLog(T)||"",oe=l.getShaderInfoLog(F)||"",me=l.getShaderInfoLog(I)||"",ue=se.trim(),B=oe.trim(),G=me.trim();let te=!0,be=!0;if(l.getProgramParameter(T,l.LINK_STATUS)===!1)if(te=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,T,F,I);else{const ye=mv(l,F,"vertex"),O=mv(l,I,"fragment");Dt("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(T,l.VALIDATE_STATUS)+`

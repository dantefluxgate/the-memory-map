...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:va,depthTest:!1,depthWrite:!1})}function av(){return new _i({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:_u(),fragmentShader:`
		...
		`,blending:va,depthTest:!1,depthWrite:!1})}function rv(){return new _i({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:_u(),fragmentShader:`
...
`].filter(Jo).join(`
`)),f=lp(f),f=mv(f,i),f=gv(f,i),h=lp(h),h=mv(h,i),h=gv(h,i),f=_v(f),h=_v(h),i.isRawShaderMaterial!==!0&&(w=`#version 300 es
